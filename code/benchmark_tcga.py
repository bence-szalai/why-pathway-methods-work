...
methods=[x[:-4] for x in os.listdir('../results/benchmark/scores/tcga/single/')]
...
for method in methods:
    print(method)
    scores=pd.read_csv('../results/benchmark/scores/tcga/single/%s.csv' % method,
    ...
    results.to_csv('../results/benchmark/rocaucs/tcga/single/%s.csv' % method,
                    sep=',')
